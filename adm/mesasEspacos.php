...
<body>
    ...
    <div class="pag1">
        <div class="parteesquerda">
            <div class="up">
                <a href="admmesas.php"><button src="" value="" style="font-size: x-large;">Administração de Mesas</button></a>
            </div>
        </div>
        <div class="partedireita">
            <div class="up">
                <a href="admespaços.php"><button src="" value="" style="font-size: x-large;">Administração de Espaços</button></a>
            </div>
        </div>
    </div>
</body>
