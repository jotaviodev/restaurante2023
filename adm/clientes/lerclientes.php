...
<div class="main-menu">
            ...
            <tbody>
                <?php
                    ...
                    while($contador < count($data)){
                        ...
                        echo "<td><img src='data:image/jpeg;base64,".$data[$contador]['foto_cliente']."'><a href='alterimage.php?id=".$data[$contador]['id_cliente']."'> Alterar</a></td>";
                        echo "<td>".
                            ...
                            "</svg>".
                            "</a>".
                            "<button class='btn btn-sm btn-danger' onclick='confirmDelete(".$data[$contador]['id_cliente'].")'>".
    ...
    <script>
        function confirmDelete(id){
            ...
            if(confirmation){
                window.location.href="./deleteclientes.php?id=" + id
            }
        }
    </script>
</body>
