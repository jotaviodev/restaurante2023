...
<body>
    ...
    <div class="pag1">
        <div class="parteesquerda">
            <div class="up">
                <a href="./funcionarios/lerfuncionarios.php"><button src="" value="" style="font-size: x-large;">Consultar</button></a>
            </div>
        </div>
        <div class="partedireita">
            <div class="up">
                <a href="./funcionarios/cadastrofuncionarios.php"><button src="" value="" style="font-size: x-large;">Cadastrar</button></a>
            </div>
        </div>
    </div>
</body>
