            ...
            <tbody>
                <?php
                    ...
                    while($contador < count($data)){
                        ...
                        echo "<td> <a href='../../index.html'>".$data[$contador]['id_clientereserva']."</td>";
                        ...
                        echo "<td>".
                            ...
                            "</svg>".
                            "</a>".
                            "<a class='btn btn-sm btn-danger' href='deleteReservasMesas.php?id=".$data[$contador]['id_reservamesa']."'>".
