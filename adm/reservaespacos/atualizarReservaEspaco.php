...
<div class="main-menu">
    ...
    <div class="pag1">
        <div class="box">
            ...
            <div class="form">
                <form action="updateReservaEspaco.php" method="POST">
                    <label for="id_reservaespaco">ID da Reserva: </label>
                    <input type="text" name="id_reservaespaco" value="<?php echo($id)?>" readonly>
                    ...
                    <label for="id_espaco">ID do Espaço: </label>
                    <input type="text" name="id_espaco" value="<?php echo($data[0]['id_espaco'])?>" readonly>
                    <label for="data_reservaespaco">Data: </label>
                    <input type="date" name="data_reservaespaco" value="<?php echo($data[0]['data_reservaespaco'])?>">
