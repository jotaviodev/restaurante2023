...
<div class="main-menu">
        ...
        <table class="table bg-info-subtle">
            <thead>
              <tr>
                ...
                <th scope="col">nome_funcionario</th>
            ...
            <tbody>
                <?php
                    ...
                    while($contador < count($data)){
                        echo "<tr>";
                        echo "<td>".$data[$contador]['id_funcionario']."</td>";
                        ...
                        echo "<td>".
                            ...
                            "</svg>".
                            "</a>".
                            "<button class='btn btn-sm btn-danger' onclick='confirmDelete(".$data[$contador]['id_funcionario'].")'>".
    ...
    <script>
         function confirmDelete(id){
            let confirmation = confirm('Você realmente deseja excluir este item?');
            if(confirmation){
                window.location.href="./deletefuncionarios.php?id=" + id
            }
        }
    </script>
</body>
