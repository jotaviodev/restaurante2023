...
<body>
    ...
    <div class="pag1">
        <div class="parteesquerda">
            <div class="up">
                <a href="admclientes.php"><button src="" value="" style="font-size: x-large;">Administração de Clientes</button></a>
            </div>
        </div>
        <div class="partedireita">
            <div class="up">
                <a href="adm.php"><button src="" value="" style="font-size: x-large;">Administração de Administradores</button></a>
            </div>
        </div>
    </div>
</body>
