...
<body>
    ...
    <div class="pag1">
        <div class="parteesquerda">
            <div class="up">
                <a href="./produtos/cadastroprodutos.php"><button src="" value="" style="font-size: x-large;">Inserir</button></a>
            </div>
        </div>
        <div class="partedireita">
            <div class="up">
                <a href="./produtos/lerprodutos.php"><button src="" value="" style="font-size: x-large;">Consultar</button></a>   
            </div>
        </div>
    </div>
</body>
