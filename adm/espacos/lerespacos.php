...
<div class="main-menu">
        ...
        <table class="table bg-info-subtle">
            <thead>
              <tr>
                ...
                <th scope="col">nome_espaco</th>
                <th scope="col">preco_espaco</th>
                <th scope="col">descricao_espaco</th>
                <th scope="col">foto_espaco</th>
                <th scope="col">...</th>
              </tr>
            </thead>
            <tbody>
                <?php
                    ...
                    while($contador < count($data)){
                        echo "<tr>";
                        echo "<td>".$data[$contador]['id_espaco']."</td>";
                        echo "<td>".$data[$contador]['nome_espaco']."</td>";
                        echo "<td>".$data[$contador]['preco_espaco']."</td>";
                        echo "<td>".$data[$contador]['descricao_espaco']."</td>";
                        echo "<td><img src='data:image/jpeg;base64,".$data[$contador]['foto_espaco']."'><a href='alterimage.php?id=".$data[$contador]['id_espaco']."'> Alterar</a></td>";
                        echo "<td>".
                            ...
                            "</svg>".
                            "</a>".
                            "<button class='btn btn-sm btn-danger' onclick='confirmDelete(".$data[$contador]['id_espaco'].")'>".
    ...
    <script>
        function confirmDelete(id){
            ...
            if(confirmation){
                window.location.href="./deleteespacos.php?id=" + id
            }
        }
    </script>
</body>
